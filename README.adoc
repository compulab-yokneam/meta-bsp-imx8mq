...
[source,console]
git clone -b master https://github.com/compulab-yokneam/meta-bsp-imx8mq.git sources/meta-compulab-som/
...
[source,console]
MACHINE=${COMPULAB_MACHINE} source sources/meta-compulab-som/meta-bsp-imx8mq/tools/setup-imx8mq-env -b build-xwayland
