...
[source,console]
git clone -b master https://github.com/compulab-yokneam/meta-bsp-imx8mq.git sources/meta-compulab-imx8mq/
...
[source,console]
MACHINE=${COMPULAB_MACHINE} source sources/meta-compulab-imx8mq/meta-bsp-imx8mq/tools/setup-imx8mq-env -b build-xwayland
